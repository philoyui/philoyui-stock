package io.philoyui.stock.client.xueqiu.request;

import io.philoyui.stock.client.xueqiu.XueQiuRequest;
import io.philoyui.stock.client.xueqiu.response.FinancialReportResponse;
